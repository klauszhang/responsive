$(function(){
    ...
    var wheight=$(window).height()-topoffset; //get height of the window
    ...
    var attractionstween=TweenMax.staggerFromTo('#attractions article',0.5,{opacity:0,scale:0},
        {delay:0.6,opacity:1,scale:1,ease:Back.easeOut})
